<template>
  ...
  <div class="swiper-wrapper" style="padding-bottom: 50px;">
    ...
    <div class="swiper-pagination" style="color: var(--mainText)"></div>
  </div>
</template>
<script>
import Swiper, { Autoplay, Navigation, Pagination ,EffectCoverflow, Keyboard, Mousewheel} from 'swiper'
import 'swiper/swiper-bundle.css'

Swiper.use([ Navigation, Pagination ,Autoplay,EffectCoverflow,Keyboard,Mousewheel]);
export default {
  name: "MyProjects",
  methods:{
 opentapo(v){
...
@media screen and (max-width: 990px){
  .my-swipper{
        transform: rotate3d(-330, 10, 0, 358deg);
    margin-top: 5px;
    margin-bottom: 17px;
  }
}
@media screen and (min-width: 990px){
  .my-swipper{
    transform: rotate3d(-210, 0, 1, 390deg);
    margin-top: 88px;
  }
}
.contain {
...
.fram1{
    ...
    z-index: 99;
    // opacity: 0.5;
    // transform: translateZ(121px) translateY(-79px);
    transform: scale(1.4);
}
.fram2{
    position: absolute;
...
.fram3{
    position: absolute;
    transform-style: preserve-3d;
    transform: translateX(-605px) translateZ(-367px) translateY(-51px) rotateY(16deg);
    width: 200px;
    height: 300px;
    // background-color: blue;
    // border: 3px solid white;
...
.fram5{
    position: absolute;
    transform-style: preserve-3d;
    transform: translateX(-440.69px) translateZ(-183px) rotateY(-4deg);
    width: 200px;
    height: 300px;
    // background-color: blue;
    // border: 3px solid white;
...
.fram6{
    position: absolute;
    transform-style: preserve-3d;
    transform: translateX(-229.21px) translateZ(-50px) rotateY(-3deg);
    width: 200px;
    height: 300px;
    // background-color: blue;
    // border: 3px solid white;
...
.fram9{
    position: absolute;
    transform-style: preserve-3d;
    transform: translateX(-440.69px) translateZ(-650px) rotateY(-150deg);
    width: 200px;
    height: 300px;
    // background-color: blue;
    // border: 3px solid white;
...
.fram10{
    position: absolute;
    transform-style: preserve-3d;
    transform: translateX(-229.21px) translateZ(-783px) rotateY(-150deg);
    width: 200px;
    height: 300px;
    // background-color: blue;
    // border: 3px solid white;
